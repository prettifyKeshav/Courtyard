        ...
        <section className="about-secA">
            <div className="container">
                <div className="flex-box">
                    ...
                    <div className="col">
                        <figure >
                            <video autoPlay muted loop playsInline poster="/assets/video/about/engineers.mp4">
                                <source src="/assets/video/about/engineers.mp4" type="video/mp4" />
                            </video>
                            {/* <video src="/assets/video/about/engineers.mp4" autoPlay loop muted playsInline ></video> */}
                        </figure>
                    </div>
                </div>
            </div>
