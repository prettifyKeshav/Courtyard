            ...
            <footer>
                    ...
                    <div className="container">
                        <div className="grid-box">
                            ...
                            <div className="grid-box-item">
                                <Link href="/">
                                    <figure>
                                        <Image src="/assets/logo.svg" width={20} height={20} alt="ico" ></Image>
                                    </figure>
                                </Link>
                            </div>
                                        ...
                                        <ul>
                                            <li>
                                                <a href="javascript:void(0);">
                                                    ...
                                                    <p>B/H. Alang House, Gotri-Sevasi Road, Gotri, Vadodara.</p>
                                                </a>
                                            </li>
                                        </ul>

                                        <div className="social-icons">
                                            <Link href="https://www.facebook.com/courtyardgroupbaroda/" target="_blank" title="Facebook">
                                            ...
                                            <Link href="https://www.instagram.com/courtyardgroupbaroda/" title="Instagram">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                            ...
                                            <Link href="https://www.linkedin.com/company/courtyard-group-vadodara/" target="_blank" title="LinkedIn">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                ...
                <div className="bottom-footer">
                    <div className="content flex">
                        <p>&copy; Courtyard Group., All rights reserved.</p>
                        <span>&nbsp; | &nbsp;</span>
